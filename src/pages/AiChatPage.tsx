            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-text-secondary">
                  基于 KV live 聚合比赛数据，做解释与推断（不依赖模型联网）。
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-3">
            {messages.map((m) => (
              ...
              >
                ...
                <div className="whitespace-pre-wrap text-sm text-text-primary">{m.content}</div>
        ...
        <div className="card space-y-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <option value="HYBRID">HYBRID（Perplexity 方法论 + Minimax JSON 结论）</option>
          ...
          <div className="text-xs text-text-secondary">
            提示：你可以问“基于当前屏幕/Top 10 候选，哪个更适合追进球？”或直接问某个联赛/球队。
          </div>
